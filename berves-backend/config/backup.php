...
return [
    ...
    'backup' => [
        ...
        /*
         * Here you can specify the path to mysqldump and pg_dump binaries.
         * If you're using XAMPP on Windows, set this to the MySQL bin directory.
         */
        'database_dumps' => [
            'db_dump_connections' => [
                env('DB_CONNECTION', 'mysql'),
            ],
            'dump_binary_path' => env('BACKUP_DB_DUMP_BINARY_PATH', 'C:\xampp\mysql\bin'),
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFICATION_EMAIL', 'admin@berves.com'),

            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'noreply@berves.com'),
                'name' => env('MAIL_FROM_NAME', 'Berves HRMS'),
            ],
        ],
